    ...
    return new Vuex.Store({
        ...
        mutations: {
            ...
            updateEvent(state, editedEvent) {
                ...
                let event_index = state.fetchedEvents.findIndex(event => event.id == editedEvent.id)
        ...
        actions: {
            ...
            nuxtServerInit(vuexContext, context) {
                ...
                return context.app.$axios.get(process.env.eventURL)
                    .then(response => {
            ...
            */
            ...
            addEvents(vuexContext, event) {
                return this.$axios.post(process.env.eventURL + "events.json", event)
                    .then(response => {
            ...
            updateEvent(vuexContext, editedEvent) {
                return this.$axios.put(process.env.eventURL + editedEvent.id + ".json", editedEvent)
                    .then(response => {
